...
#ifndef CODEGEN_EXPORT_SYM
#ifdef _MSC_VER
#define CODEGEN_EXPORT_SYM __declspec(dllexport)
#elif __GNUC__ >= 4
#define CODEGEN_EXPORT_SYM __attribute__((visibility("default")))
#else
#define CODEGEN_EXPORT_SYM
#endif
#endif
 ...
 */
#define EMLRT_VERSION_R2019B 0x2019B
#define EMLRT_VERSION_INFO EMLRT_VERSION_R2019B
...
/*
 * MATLAB INTERNAL USE ONLY :: Prototype of jit free functions.
 */
typedef void (*EmlrtHeapReferenceJITFreeFcn)(void*, void*);

/*
 * MATLAB INTERNAL USE ONLY :: Prototype of free functions.
 */
typedef void (*EmlrtHeapReferenceFreeFcn2018a)(const void*, void*);

/*
 * MATLAB INTERNAL USE ONLY :: Prototype of JIT free functions
 */
typedef void (*EmlrtHeapReferenceJITFreeFcn2018a)(void*, const void*, void*);

/*
 * MATLAB INTERNAL USE ONLY :: Prototype of free functions.
 */
typedef void (*EmlrtSyncFcn)(emlrtConstCTX aTLS);
typedef void (*EmlrtJITSyncFcn)(void*, emlrtConstCTX);
...
/*
 * MATLAB INTERNAL USE ONLY :: Create and initialize a sparse matrix
 */
 ...
 */
EXTERN_C LIBEMLRT_API const mxArray* emlrtGetFieldR2013a(emlrtConstCTX aTLS,
 ...
 * MATLAB INTERNAL USE ONLY :: free with memory integrity check
 */
EXTERN_C LIBEMLRT_API void emlrtFree2018a(emlrtConstCTX aTLS, void* aPtr);
 ...
 * MATLAB INTERNAL USE ONLY :: free for MEX
 */
EXTERN_C LIBEMLRT_API void emlrtFreeMex2018a(emlrtConstCTX aTLS, void* aPtr);
 ...
 */
EXTERN_C LIBEMLRT_API void emlrtPushHeapReferenceStackR2012b(emlrtConstCTX aTLS,
                                                             void* aHeapReference,
                                                             EmlrtHeapReferenceFreeFcn aFreeFcn);

/*
 * MATLAB INTERNAL USE ONLY :: Push a new entry to the heap reference stack.
 */
EXTERN_C LIBEMLRT_API void emlrtPushHeapReferenceStackR2018a(
    emlrtConstCTX aTLS,
    void* aHeapReference,
    EmlrtHeapReferenceFreeFcn2018a aFreeFcn);

/*
 * MATLAB INTERNAL USE ONLY :: JIT Push a new entry to the heap reference stack.
 */
EXTERN_C LIBEMLRT_API void emlrtPushHeapReferenceStackJITR2018a(
    emlrtConstCTX aTLS,
    void* aHeapReference,
    void* aJITInstance,
    EmlrtHeapReferenceJITFreeFcn2018a aFreeFcn);

EXTERN_C LIBEMLRT_API void emlrtPushHeapReferenceStackJITR2012b(
    emlrtConstCTX aTLS,
    void* aHeapReference,
    void* aJITInstance,
    EmlrtHeapReferenceJITFreeFcn aFreeFcn);

/*
 * MATLAB INTERNAL USE ONLY :: Push a new entry to the heap reference stack.
 */
EXTERN_C LIBEMLRT_API void emlrtSetGlobalSyncFcn(emlrtConstCTX aTLS, EmlrtSyncFcn aSyncFcn);
...
/*
 * MATLAB INTERNAL USE ONLY :: Lookup for entry point using decision tree.
 * This function will call back to MATLAB to use the decision tree constructed during
 * codegen.
 */
EXTERN_C LIBEMLRT_API int emlrtGetPolyEntryPointIndex(emlrtConstCTX aTLS,
                                                      int32_T nrhs,
                                                      mxArray* prhs[]);
 ...
 * MATLAB INTERNAL USE ONLY :: Allocate the root thread-local storage.
 */
EXTERN_C LIBEMLRT_API void emlrtCreateRootTLS(emlrtCTX* aRootTLS,
 ...
 */
EXTERN_C LIBEMLRT_API int32_T emlrtStrlen(const char*);
 ...
 */
EXTERN_C LIBEMLRT_API void emlrtMEXProfilingToggle(int32_T statusValue);
 ...
 */
EXTERN_C LIBEMLRT_API void emlrtThinCUDAError(bool initFlag,
                                              emlrtConstCTX aTLS);
...
EXTERN_C LIBEMLRT_API char* emlrtGetEnv(const char* aVar);

typedef void (*mexFunctionPrt)(int32_T, void*, int32_T, void*);
EXTERN_C LIBEMLRT_API void emlrtCaptureInputs(const mxArray** data,
                                              int32_T numInputs,
                                              mexFunctionPrt aFcnPtr);
